...
Func EZUpdate($sSourceURL, $sTargetName, $sVisibleName, $sTargetDir = @TempDir, $bProgressOff = True, $iEndMsgTime = 2000, $sDownloaderTitle = "Downloading")
	...
	; Show progress UI
	ProgressOn($sDownloaderTitle, "xUpdater - Downloading  Updates" & $sVisibleName)
